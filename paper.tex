...
% TODO::EASY Cite: J. M. Overhage, P. B. Ryan, C. G. Reich, A. G. Hartzema, and P. E. Stang, “Validation of a common data model for active safety surveillance research,” Journal of the American Medical Informatics Association, vol. 19, no. 1, pp. 54–60, 2012.
...
% TODO::EASY Add citation from OHDSI website's collaborator statistics
...
% TODO::EASY This paragraph should be centered on the core technology of data standards -- in particular, the OMOP CDM
...
% TODO::EASY Cite Discourse post on start of JuliaHealth
...
% TODO::EASY Cite FunOHDSI
% TODO::EASY Cite OHDSICohortExpressions
...
% TODO::EASY Cite schema of the definition from GitHub
...
% TODO::EASY Cite package
% TODO::MEDIUM Reframe this to more say how ATLAS can be used to build cohorts
% TODO::EASY Explain how this package to accomplish similar tasks
...
% TODO::EASY Change this list into an enumeration
...
% TODO::EASY Mention JuliaCon Birds of a Feather discussion
...
% TODO::EASY Enumerate these two datasets
% EXPLAIN::EASY In enumeration talk about what Eunomia is 
% EXPLAIN::EASY In enumeration discuss MIMIC III
% TODO::EASY Cite MIMIC III, MIT LCP, and OMOP-ification process
...
% TODO::MEDIUM Maybe remove package imports and mention them within the caption instead
...
% TODO::EASY Add figure, caption, and label details
...
% TODO::EASY Move this to a caption
...
% TODO::EASY Add figure, caption, and label details
% TODO::EASY Maybe remove package imports and mention them within the caption instead
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
...
% EXPLAIN::EASY Move this to the caption of the table
...
% TODO::EASY Create reference to Eunomia table
...
% TODO::EASY Convert this to an enumeration
...
% TODO::MEDIUM Maybe move this into the tutorial code
% TODO::EASY Add figure, caption, and label details
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
import Base:
  Fix2
...
% TODO::EASY Add this to previous code caption
...
% TODO::MEDIUM Do we even need chaining here or could we use direct composition of functions?
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
import Chain:
  @chain
...
% TODO::MEDIUM Can this be simplified?
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
...
% TODO::HARD Review and probably remove appendix
