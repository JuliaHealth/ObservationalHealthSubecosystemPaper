...
% EXPLAIN: What is observational health research? Done
...
% TODO: Add citation from OHDSI website's collaborator statistics
% EXPLAIN: Why is mapping relevant here?
...
% TODO: This paragraph should be centered on the core technology of data standards -- in particular, the OMOP CDM
% EXPLAIN: What is real world data? Use https://jacobzelko.com/10282021140730-real-world-evidence/
...
% TODO: Combine the next two sentences together
% EXPLAIN: What does "person-centered" mean?
% EXPLAIN: What is a patient event? Could you give an example?
...
% TODO: Develop this fragment into a full sentence
...
% TODO: Make this more coherent to the rest of the paragraph
% TODO: Explicitly mention that although the model prescribes a database schema, it does not need a specific database type
The OMOP CDM itself does not require a specific technology to work with the data stored in this standard.

% TODO: This paragraph should be centered on the core technology of the concept of network studies
% TODO: Use this to address the notion of what "network studies" are
% TODO: Make this initially less OHDSI specific; pull from https://jacobzelko.com/05122023034151-network-macarthur
...
% TODO: Carry HADES discussion into the paragraph talking about research tooling
...
% TODO: Make this more general such that it flows into the next paragraph on research tooling better
a research group can develop their analysis on their own OMOP CDM instance and then bundle together their study.
% EXPLAIN: What is a study package?
% EXPLAIN: What data assets?
...
% EXPLAIN: What is a collaborator network?
...
% TODO: Develop this paragraph more about research software
...
% TODO: Add a paragraph here about what is a phenotype definition
% TODO: Cite my paper here

% TODO: Segue this better from phenotype definitions
...
% TODO: Cite schema of the definition from GitHub
% EXPLAIN: Better introduce what SQL is
...
% TODO: Cite package
% TODO: Reframe this to more say how ATLAS can be used to build cohorts
% TODO: Explain how this package to accomplish similar tasks
...
% TODO: Change this list into an enumeration
...
% EXPLAIN: What is a prepared statement?
% EXPLAIN: What is a cohort in this context?
...
% EXPLAIN: How so?
% TODO: Review this sentence; maybe cut it
...
% TODO: Move this to the previous section on phenotype definitions
...
% TODO: Present this more as a general introduction to what tools are here for this
% TODO: Talk about composition with DataFrames or Tidier
...
% TODO: Mention the ability to satisfy research requests
...
% TODO: Mention JuliaCon Birds of a Feather discussion
...
% TODO: Change the phrasing of this
...
% TODO: Better introduce this
For that reason, DBConnector.jl was created.
% EXPLAIN: Contextualize this a bit better
...
% TODO: Combine with the previous paragraph and state that there are two approaches
% TODO: Make explicit DBConnector's path
% TODO: Make explicit the path of choosing general packages
...
% TODO: Review if this section is actually needed
...
% TODO: Reference code repository
...
% TODO: Enumerate these two datasets
% EXPLAIN: In enumeration talk about what Eunomia is 
% EXPLAIN: In enumeration discuss MIMIC III
% TODO: Cite MIMIC III, MIT LCP, and OMOP-ification process
...
% TODO: Mention in footnote explicitly that reproducing workflow in Eunomia is possible
% TODO: Mention in footnote that explicitly reproducing workflow in MIMIC III is possible but not readily accessible
...
Please review the associated code repository for a full working tutorial.}
...
% TODO: Update DBConnector
% TODO: Maybe remove package imports and mention them within the caption instead
...
% TODO: Review if this subsection is needed
...
% TODO: Add figure, caption, and label details
% TODO: Maybe remove package imports and mention them within the caption instead
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
using JSON3 
...
% EXPLAIN: Move this to the caption of the table
...
% TODO: Create table for MIMIC III results
% TODO: Create reference to Eunomia table
...
% EXPLAIN: What is the overview of this section?
% EXPLAIN: What does each topic do?
...
% TODO: Make this more explicit about utilizing Julia's composition
...
% TODO: Tie into currying more directly
% TODO: Check if I am mentioning currying correctly
...
% TODO: Rewrite this part in light of the previous sections 
...
% TODO: Rework this section further
...
% TODO: Maybe move this into the tutorial code
% TODO: Add figure, caption, and label details
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
import Base:
  Fix2
...
% TODO: Add this to previous code caption
NOTE: The "C" prefix for each of our curried functions denotes that it is curried.

% EXPLAIN: Refactor this paragraph better or put most of it into the caption for the next code block
...
% TODO: Do we even need chaining here or could we use direct composition of functions?
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
import Chain:
  @chain
...
% TODO: Move this into the future discussion section
...
% TODO: Move this into its own section
...
% TODO: Redo example; I do not feel it is good
\begin{minted}[breaklines,escapeinside=||,mathescape=true, numbersep=3pt, gobble=2, frame=lines, fontsize=\scriptsize, framesep=2mm]{julia}
import Distributed:
  @distributed 
...
% TODO: Rephrase this sentence better
% TODO: Cite ANSI SQL
...
% EXPLAIN: Highlight this more
% EXPLAIN: In what scenarios might using Julia may not be possible
...
% TODO: Combine this section with the future directions section
...
% TODO: Rephrase this introductory paragraph
...
% TODO: This is where to introduce the paradox of composition
...
% TODO: Combine this paragraph with the previous paragraph
% TODO: Shorten this sentiment
...
% TODO: Make this more about the flexible nature of the JuliaHealth organization
...
% TODO: Mention how this allows JuliaHealth to solve more problems than what is present within JuliaHealth
...
% TODO: Review and remove appendix
